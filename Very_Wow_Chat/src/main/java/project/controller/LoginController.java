...
public class LoginController {
  ...
  public ResponseEntity<String> login(@RequestBody LoginFormReciver payload) throws Exception {
	...
	/* If an enmpty send was somehow made we will handle it
	 * we resonde with a 400 status code along with json error */
     ...
     * sed username if it does not then we responde with status code of 401 and json erro  */
