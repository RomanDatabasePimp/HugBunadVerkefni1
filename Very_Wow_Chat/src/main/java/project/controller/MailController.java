...
public class MailController {
  ...
  /* Usage : send() 
      For  : ekkert 
     After : tries to call the tryToSend method to send the email */
  public void send() {
    try { this.tryToSend(); } 
  ...
  /* Usage : tryToSend()
      For  : nothing
     After : create a json obj with parameters toMail,content,seckey that will be sent to the webserver */
  public void tryToSend() throws Exception {
    ...
    /* I wrote this last semester for hugbunadar verkefni 1 i am abit fuzzy on the details on how it worked a 100% :( */
