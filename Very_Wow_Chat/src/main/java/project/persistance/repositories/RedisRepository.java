...
public RedisRepository() {
	/* Since the Spring boot server will be deployed on Roman's Server all the databases
	 * are hosted localy on the same server so we can just define our server connections as local */
