...
public class TagService {
	...
	public TagService(ChatroomRepository chatroomRepository, TagRepository tagRepository) {
	...
	public List<Chatroom> findListedChatroomsWithTag(String tagName) {
		...
		// fetch the chatrooms
		List<Chatroom> chatrooms = chatroomNames.stream().map(x -> this.chatroomRepository.findByChatroomName(x)).collect(Collectors.toList());
